...
export function Hero({ lang }: HeroProps) {
  ...
  return (
    <section className="relative isolate flex min-h-[600px] items-center overflow-hidden bg-[#1E3A8A] py-20 text-white lg:min-h-[680px] lg:py-24">
      {heroImages.map((img, index) => (
        <div
          key={img}
          className={cn(
            "pointer-events-none absolute inset-0 bg-cover bg-center transition-opacity duration-1000",
      ...
      <button
        ...
        className="pointer-events-auto absolute left-4 top-1/2 z-30 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-white/30 bg-white/10 text-white backdrop-blur-sm transition-colors hover:bg-white/20 lg:left-6 lg:h-12 lg:w-12"
      ...
      <button
        ...
        className="pointer-events-auto absolute right-4 top-1/2 z-30 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-white/30 bg-white/10 text-white backdrop-blur-sm transition-colors hover:bg-white/20 lg:right-6 lg:h-12 lg:w-12"
